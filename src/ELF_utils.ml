...
(*TODO: might want to make it faster in presence of many sections*)
...
(**
   ...
   that is, the space it occupies in the file. Does not look past segment
   borders, returns None in such cases.
*)
(*
...
let ndxes_of_sym_name (e: elf) (name: string): int list =
  try StringMap.find name e.e_syms_by_name with Not_found -> []
*)
(**
